...
@Service
public class Yes876BankServiceImpl implements MultipartyReconServiceInterface {
		...
		public void readTransactionFile(File file, String username) throws IOException, ParseException {
			...
			CSVReader reader;
		        ...
		        while((line=reader.readNext())!=null)
		        {
		        	...
		        	bankTransactionEntity.setBankCode("YES 876 Bank");
		        	bankTransactionEntity.setRemarks(lineArr[9]);
		        	bankTransactionEntity.setFileName(fileName);
		        	bankTransactionEntity.setPartner("YBL");
		        	bankTransactionEntity.setTxnType("REMITTANCE");
		        	try {
